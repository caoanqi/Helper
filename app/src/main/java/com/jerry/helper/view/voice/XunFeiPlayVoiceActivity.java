...
public class XunFeiPlayVoiceActivity extends AppCompatActivity implements View.OnClickListener {

    private static String TAG = XunFeiPlayVoiceActivity.class.getSimpleName();
    // 语音合成对象
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xun_fei_play_voic);
...
//                Intent intent = new Intent(XunFeiPlayVoiceActivity.this, TtsSettings.class);
...
//			int code = mTts.synthesizeToUri(text, path, mTtsListener);
    ...
    private String getResourcePath() {
        ...
        //合成通用资源
        tempBuffer.append(ResourceUtil.generateResourcePath(this, ResourceUtil.RESOURCE_TYPE.assets, "iflytek/tts/common.jet"));
        tempBuffer.append(";");
        //发音人资源
        tempBuffer.append(ResourceUtil.generateResourcePath(this,
                ResourceUtil.RESOURCE_TYPE.assets, "iflytek/tts/" + XunFeiPlayVoiceActivity.voicerLocal + ".jet"));
