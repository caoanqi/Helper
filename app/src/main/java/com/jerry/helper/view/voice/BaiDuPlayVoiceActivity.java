 ...
 */
public class BaiDuPlayVoiceActivity extends AppCompatActivity {

    /**
     * 播放合成语音内容
     */
    private static final String TEXT = "百度语音播报";
     ...
     */
    protected String appId = "15548442";

    protected String appKey = "4VUHnss8SnSwfwZ5F6HgUjGl";

    protected String secretKey = "6tsLxx6Cq29fk9cEGPDUFCmDW7Z2m5St";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bai_du_play_voice);
        initView();
        initPermission();
        initTTs();
    }
